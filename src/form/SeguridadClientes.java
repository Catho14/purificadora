 ...
 * @author User
 */
public class SeguridadClientes extends javax.swing.JFrame {

    /**
     * Creates new form Seguridad
     */
    public SeguridadClientes() {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
      ...
      String Contraseña;
         ...
         RegistroClientes abrirmenu= new RegistroClientes();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SeguridadClientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SeguridadClientes().setVisible(true);
            }
        });
    }
